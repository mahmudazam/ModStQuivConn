...
theory \cites{HyperbolicBandTheory, AutBlochTheorems, HypBloch}, are centred around
...
Given any finite simplicial set $I$ and a smooth formal groupoid $(X, \sF)$ with $X \to S$ projective and smooth, choose a smooth atlas
...
This allows us to consider analytifications of $A, R$ \cite{GenGAGA} to obtain a groupoid object
